...
export class GetStreamLambdaConstruct extends Construct {
  ...
  constructor(scope: Construct, id: string, props: GetStreamLambdaConstructProps) {
    ...
    const lambdaCodePath = path.join(__dirname, '../../../../functions/lambda/streaming/get-stream/get-stream-lambda.ts')
    this.function = new NodejsFunction(this, 'GetStreamFunction', {
