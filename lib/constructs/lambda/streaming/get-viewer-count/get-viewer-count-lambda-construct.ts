...
export class GetViewerCountLambdaConstruct extends Construct {
  ...
  constructor(scope: Construct, id: string, props: GetViewerCountLambdaConstructProps) {
    ...
    const lambdaCodePath = path.join(__dirname, '../../../../functions/lambda/streaming/get-viewer-count/get-viewer-count-lambda.ts')
    this.function = new NodejsFunction(this, 'GetViewerCountFunction', {
