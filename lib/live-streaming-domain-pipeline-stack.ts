 ...
 * 
 * Self-contained pipeline infrastructure for the live-streaming-domain domain:
...
export interface LiveStreamingDomainPipelineStackProps extends cdk.StackProps {
  domain: string;
...
export class LiveStreamingDomainPipelineStack extends cdk.Stack {
  public readonly artifactBucket: s3.Bucket;

  constructor(scope: Construct, id: string, props: LiveStreamingDomainPipelineStackProps) {
