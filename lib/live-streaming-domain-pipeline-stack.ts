...
export interface LiveStreamingLiveStreamingDomainPipelineStackProps extends cdk.StackProps {
  domain: string;
...
export class LiveStreamingDomainPipelineStack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props: LiveStreamingLiveStreamingDomainPipelineStackProps) {
